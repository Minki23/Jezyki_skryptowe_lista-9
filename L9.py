...
import datetime
from typing import Dict, List, Union, Optional, Callable, Iterator
...
def main() -> None:
  ...
  # x = SSHLogEntry(content='Dec 10 06:55:48 LabSZ sshd[24200]: Failed password for invalid user webmaster from')
